...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/ondanbitmis")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Open Source 🌱",url="https://github.com/derdomucis/TgEglenceBot")]]
